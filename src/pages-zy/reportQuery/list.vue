  ...
  <view style="padding-top: 240rpx;">
    ...
    <view class="checkNavgate">
      <template v-if="active == 0">
        <view class="finishList box-shadow" v-for="(item, index) in testList1" :key="index" @click="
              goto(
          ...
          <view class="listContent">
            <view class="contentLeft">
              <view class="leftTop">
                <view class="title text-overflow">{{ item.reportTitle || '-'}}</view>
              </view>
              <view class="group1">
              ...
              <view class="group2">
                <view class="Item1">报告医生：{{ item.reportorName || '-' }}</view>
      ...
      <template v-else>
        <view class="finishList box-shadow" v-for="(item, index) in testList2" :key="index" @click="
              goto(
