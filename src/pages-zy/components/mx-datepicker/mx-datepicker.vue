<template>
	<view  class="picker">
        ...
        <view class="confirm" :style="{background:color}" :hover-stay-time="100" hover-class="picker-btn-active" @click="onConfirm">确定</view>
			</view>
		</view>
		<!-- 时间选择器 -->
		<view v-if="showTimePicker" class="picker fiexd">
