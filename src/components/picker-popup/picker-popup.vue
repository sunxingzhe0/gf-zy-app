  ...
  <view>
    <uni-popup type="bottom" ref="popup">
      <view class="time-popup">
        ...
        <picker-view class="picker-view" :indicator-style="indicatorStyle" :value="value" @change="timeChange">
          <picker-view-column>
    ...
    methods: {
      ...
      calculationDay(val) {
        ...
        if (this.month == 2) {
          ...
          if (this.month == 1 || this.month == 3 || this.month == 5 || this.month ==
            7 || this.month == 8 || this.month == 10 || this.month == 12) {
        ...
        //过滤过期日期
        if ( this.year == nowD.getFullYear() && this.month == (nowD.getMonth() + 1)) {
        ...
        if (this.year == nowD.getFullYear() && this.month == (nowD.getMonth() + 1)&& this.day == nowD.getDate() ) {
        ...
        if (this.year == nowD.getFullYear() && this.month == (nowD.getMonth() + 1)&& this.day == nowD.getDate() && this.hour == nowD.getHours()) {
      ...
      timeConfirm() {
        ...
        //判断选择时间是否在当前时间前
        var nowD = new Date()
        var sTime = this.year + "/" + this.month + "/" + this.day + ' ' + this.hour + ':' + this.minute
        var now = nowD.getFullYear() + "/" + (nowD.getMonth() + 1) + "/" + nowD.getDate() + ' ' + nowD.getHours() + ':' +
          nowD.getMinutes()
