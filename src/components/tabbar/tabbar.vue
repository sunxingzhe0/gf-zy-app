    ...
    >
      <view class="itmMain" @click.stop="switchTabFunc(0)">
        <image
          ...
          :fade-show="false"
          v-if="active != 0"
          :src="require('@/assets/user/user_main.png')"
        ></image>
        <image
          class="imgse"
          :fade-show="false"
          v-if="active === 0"
          :src="require('@/assets/user/user_main_s.png')"
        ></image>
      ...
      <view class="itmMain" @click.stop="switchTabFunc(1)">
        <image
          ...
          :fade-show="false"
          v-if="active != 1"
          :src="require('@/assets/user/user_consultation.png')"
        ></image>
        <image
          class="imgse"
          :fade-show="false"
          v-if="active === 1"
          :src="require('@/assets/user/user_consultation_s.png')"
        ></image>
      ...
      <view class="itmMain" @click.stop="switchTabFunc(2)">
        <image
          ...
          :fade-show="false"
          v-if="active != 2"
          :src="require('@/assets/user/user_mine.png')"
        ></image>
        <image
          class="imgse"
          :fade-show="false"
          v-if="active === 2"
          :src="require('@/assets/user/user_mine_s.png')"
        ></image>
