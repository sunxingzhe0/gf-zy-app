  ...
  <view class="tabbarMain" :class="[flagTypeInfo? 'tabbarMainIphone':'']">
    <view class="tabBtnMina" :class="[flagTypeInfo? 'tabBtnMinaIphone':'']" mode="">
      ...
      <view class="itmMain" @click.stop="switchTabFunc(1)">
        <image class="imgse" :fade-show='false' v-if="active!=1" :src="require('@/assets/user/user_mine.png')"></image>
        <image class="imgse" :fade-show='false' v-if="active===1" :src="require('@/assets/user/user_mine_s.png')"></image>
        <text class="txtBtn" :class="{'txtBtnSel' :active==1}">我的</text>
      </view>
    </view>
