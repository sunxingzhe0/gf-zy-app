...
export function finishAuth(data) {
  return request('/api/v1/patient/finishAuth', data)
}
// 确认就诊人信息
...
export function getIdCardInfo(data) {
  return request('/api/v1/patient/getIdCardInfo', data, 'GET')
}

// 健康建卡信息提交
export function submitCardInfo(data) {
  return request('/api/v1/patient/submitCardInfo', data, 'POST')
}
//获取健康卡信息
export function getInfoByHealthCode(data) {
  return request('/api/v1/patient/getInfoByHealthCode', data, 'GET')
}

//获取消息类型id对应的订单类型
export function getMsgOrderType(data) {
  return request('/api/v1/order/getOrderType', data, 'GET')
}

//获取职业列表
export function getDictList(data) {
  return request('/api/v1/patient/getDictList', data, 'GET')
}

//解析手机号
export function getMiniPhoneByCode(data) {
  return request('/api/v1/wxLogin/getMiniPhoneByCode', data, 'GET')
}

//获取门诊号  cardNo
export function getOutSno(data) {
  return request('/api/v1/appointment/getOutSno', data, 'GET')
}
