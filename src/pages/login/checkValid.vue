      ...
      <uni-list class="inputWrap">
        <uni-list-item style="padding-left: 0;" :show-arrow="false">
          <view class="flex-between">
            ...
            <input :disabled="true" type="" class="flex_1" v-model="phone" maxlength="11" placeholder-style="color:#ccc;font-size: 30rpx;" placeholder="请输入手机号" />
          </view>
        </uni-list-item>
        <uni-list-item style="padding-left: 0;" :show-arrow="false">
          <view class="flex-between">
...
<script>
import { verificationCode, userArchiveCheck, finMiniProgramAuth } from '@/common/request/index';
export default {
  data() {
    return {
      timecode: 60,
