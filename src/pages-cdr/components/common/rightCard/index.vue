<template>
  ...
  <view class="right-view" v-if="flag.diagnoseFlag">
    <view class="header">
      <view class="line"></view>
      <view class="title">诊断</view>
      <view class="other" @click="changeTab(1)">更多 ></view>
    </view>
      <view class="body" v-for="(item,diagnose) in diagnoseBox" :key="diagnose">
        <view class="title">
  ...
  <view class="right-view" v-if="flag.prescDetailFlag">
    <view class="header">
      <view class="line"></view>
      <view class="title">门诊处方</view>
      <view class="other" @click="changeTab(3)">更多 ></view>
    </view>
      <view class="body" v-for="(item,prescDetail) in prescDetailBox" :key="prescDetail">
        <view class="title">
