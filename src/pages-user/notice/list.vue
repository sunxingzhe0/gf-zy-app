  ...
  <view>
    ...
    <view class="doctorWrap">
      <view class="search flex-between box-shadow">
        <input type="text" v-model="searchKeywords" placeholderClass="searchtext" placeholder='按公告标题搜索' @input=input() />
    ...
    <view class="box-shadow bg">
      <view class="list " v-for="(item, index) in list" :key="index" @click="toInfo(item.id)">
        ...
        <view class="info overflow-hidden text-overflow" v-html='item.body'></view>
      </view>
    </view>
