    ...
    <homeIcom />
		<view class="box-shadow oerderMain">
			...
			<view class="orderItem">
				...
				<textarea class="textarea" v-model="form.allergies" placeholder-class="placeholder" maxlength="200" placeholder="请输入过敏史，限200字内"/>
			</view>
			<view class="orderItem">
				<view class="font30 color333">既往史</view>
				<textarea class="textarea" v-model="form.pastHistory" placeholder-class="placeholder" maxlength="50" placeholder="请输入既往史，限50字内"/>
			</view>
		</view>
		<button class="submit_btn" @click="submit" type="primary">保存</button>
		<view class="font30 pricolor"	style="text-align: center; cursor: pointer;" @click="goto">跳过</view>
	</view>
</template>
