<template>
  <view style="padding: 20rpx;">
    ...
    <view
      isShadow
      class="box-shadow"
      style="background: #fff; overflow: hidden;padding-left: 30rpx; padding-right: 30rpx;"
    >
        ...
        <uni-list-item style="padding-left: 0;">
          <view class="flex-start-center">
            ...
            >
              <view
                class="flex_1"
                :style="{ width: '330rpx', color: cityName ? '#333' : '#ccc' }"
                >{{ cityName || '请选择' }}</view
              >
            </pick-regions>
          </view>
    ...
    <button class="submit_btn addressBtn" type="primary" @click="submit">
      保存
    </button>
  </view>
</template>
