<template>
  <view class="container">
    ...
    <view class="flex-start-start" style="margin: 39rpx 0rpx 40rpx 100rpx;">
      <view class="collect">收</view>
      <view style="font-size:24rpx;
font-weight:bold;
color:rgba(134,134,134,1);">重庆市渝北区光电园水星1号楼</view>
    </view>
    <block v-for="(item, index) in tracesData" :key="index">
      <track-node :is-first="index === tracesData.length - 1" :is-newest="index === 0" :is-main-node="item.isMainNode"
        :node-data="item"></track-node>
    </block>
  </view>
</template>
