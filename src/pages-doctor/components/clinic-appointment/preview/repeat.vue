    ...
    <view class="app-card">
      ...
      <view class="biz-wrapper">
        ...
        >
          ...
          <view v-else>暂未开通</view>
        </view>
      </view>
      <view :style="{ marginTop: '28rpx', marginLeft: '20rpx' }">
...
export default {
  ...
  methods: {
    goChange() {
      uni.navigateTo({
        url: `/pages-user/home/online/Consultation?type=REPEAT_CLINIC&title=选择预约医生&deptId=${this.info.deptId}&isAppoint=1`,
      })
    },
    onBizClick(bizId) {
