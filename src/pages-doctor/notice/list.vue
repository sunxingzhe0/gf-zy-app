    ...
    <homeIcom />
		<view class="doctorWrap">
			<view class="search flex-between box-shadow">
				<input type="text" v-model="searchKeywords" class="flex_1"  @input="searchTap" placeholderClass="searchtext" placeholder="搜索关键字" />
				<uni-icons type="search" class="searchIcon" size="20" @click="searchTap"></uni-icons>
			</view>
		</view>
		<view class="box-shadow bg">
			<view class="list " v-for="(item, index) in list" :key="index" @click="toInfo(item.id)">
